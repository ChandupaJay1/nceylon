...
<div class="min-h-screen bg-surface flex">
    ...
    <div class="flex-1 lg:ml-64 pt-10 pb-16 px-6 lg:px-10">
        <div class="max-w-lg">
            ...
            <h1 class="text-3xl font-heading font-black text-secondary mb-8">Add Stock Status</h1>

            <form action="{{ route('admin.stock-statuses.store') }}" method="POST"
                ...
                <div>
                    ...
                    <div class="grid grid-cols-5 gap-3">
                        ...
                        <label class="cursor-pointer">
                            <input type="radio" name="color" value="{{ $color }}" class="sr-only peer" @checked(old('color', 'green') === $color)>
                    ...
                    @error('color') <p class="text-red-500 text-xs mt-1.5 font-semibold">{{ $message }}</p> @enderror
                </div>
                ...
                <div class="flex gap-3 pt-4 border-t border-gray-100">
                    <button type="submit" class="flex-1 bg-primary hover:bg-primary-dark text-white font-black py-3.5 rounded-xl transition-all text-sm">
                        <i class="fas fa-save mr-2"></i> Create Status
                    </button>
