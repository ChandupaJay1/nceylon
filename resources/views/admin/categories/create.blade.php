...
<div class="min-h-screen bg-surface flex">
    ...
    <div class="flex-1 lg:ml-64 pt-10 pb-16 px-6 lg:px-10">
        ...
        <div class="max-w-lg">
            ...
            <h1 class="text-3xl font-heading font-black text-secondary mb-8">Add Category</h1>
            ...
            <form action="{{ route('admin.categories.store') }}" method="POST"
                ...
                <div>
                    ...
                    <input type="number" name="sort_order" value="{{ old('sort_order', 0) }}" min="0"
                           ...
                           placeholder="0">
                    <p class="text-xs text-secondary/40 mt-1.5">Lower numbers appear first in dropdowns</p>
                </div>
                ...
                <label class="flex items-center gap-3 cursor-pointer pt-2">
                    ...
                    <span class="text-sm font-semibold text-secondary">Active (visible in product forms)</span>
                </label>
