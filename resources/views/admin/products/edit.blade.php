...
<div class="min-h-screen bg-surface flex">
    ...
    <div class="flex-1 lg:ml-64 pt-10 pb-16 px-6 lg:px-10">
        ...
        <div class="mb-10">
            ...
            <h1 class="text-3xl font-heading font-black text-secondary">Edit Product</h1>
        </div>
        ...
        <form action="{{ route('admin.products.update', $product) }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-lg shadow-lg p-8 space-y-6">
            ...
            <div>
                ...
                <div class="mb-4 p-4 bg-gray-50 rounded-lg border border-gray-200">
                    ...
                    <img src="{{ $product->image_url }}" alt="{{ $product->name }}" class="w-24 h-24 rounded object-cover">
                </div>
                @endif
            ...
            <div class="grid grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select id="stock_status" name="stock_status" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:border-primary @error('stock_status') border-red-500 @enderror">
                        ...
                        <option value="{{ $status->name }}" @selected(old('stock_status', $product->stock_status) === $status->name)>{{ $status->name }}</option>
                        @endforeach
                    </select>
