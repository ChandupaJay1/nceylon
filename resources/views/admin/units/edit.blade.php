...
<div class="min-h-screen bg-surface flex">
    ...
    <div class="flex-1 lg:ml-64 pt-10 pb-16 px-6 lg:px-10">
        <div class="max-w-lg">
            ...
            <h1 class="text-3xl font-heading font-black text-secondary mb-8">Edit Unit</h1>
            ...
            <form action="{{ route('admin.units.update', $unit) }}" method="POST"
                ...
                <div>
                    ...
                    <input type="number" name="sort_order" value="{{ old('sort_order', $unit->sort_order) }}" min="0"
                ...
                <label class="flex items-center gap-3 cursor-pointer pt-2">
                    <input type="checkbox" name="is_active" value="1" class="w-4 h-4 rounded border-gray-300 text-primary focus:ring-primary" @checked(old('is_active', $unit->is_active))>
